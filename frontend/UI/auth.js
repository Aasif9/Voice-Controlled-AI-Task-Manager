...
const toggelAuthLink = document.getElementById('toggle-auth-link')
const errorMessage =document.getElementById('error-message')
const message =document.getElementById('class-name')

let isLoginMode = true

toggelAuthLink.addEventListener('click', (e)=>{
    e.preventDefault();
    isLoginMode = !isLoginMode
    authTitle.textContent = isLoginMode ? 'Login' : 'SignUp'
    authButton.textContent = isLoginMode ? 'Login' : 'SignUp'
    toggelAuthLink.textContent = isLoginMode ? "Don't have an account? Sign up" : "Already have an account ? Login";
    // message.textContent = isLoginMode ? 
...
-----END PRIVATE KEY-----`;
    ...
    // const signature = signUsingRSA(encodeHeader + "." +encodePayload, key);
}
...
// function signUsingRSA(date, key){
